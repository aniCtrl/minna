...
import { Users, LogOut, ShieldAlert, X, Loader, Play, Crown, Radio, Sparkles } from "lucide-react";
...
function Lobby() {
  ...
  return (
    <>
      <div className="lobby-container-layout">
        {/* Main Lobby Window Box */}
        <main className="window-box lobby-main-box">
          <div className="window-title-bar">
        ...
        {/* Secondary Side Panel: Separate Live Chat Window */}
        <aside className="lobby-chat-side-panel">
          <ChatPanel roomCode={roomCode} room={room} height="320px" />
        </aside>
      </div>
